...
struct VMESend_args:Thread_args{
...
class VMESend: public Tool {


 public:

  VMESend(); ///< Simple constructor
 ...
 private:
  ...
  VMESend_args* args; ///< thread args (also holds pointer to the thread)
