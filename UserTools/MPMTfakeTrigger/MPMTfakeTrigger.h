#ifndef MPMTfakeTrigger_H
#define MPMTfakeTrigger_H
...
/**
 * \struct MPMTfakeTrigger_args_args
 *
...
struct MPMTfakeTrigger_args:Thread_args{
...
class MPMTfakeTrigger: public Tool {


 public:

  MPMTfakeTrigger(); ///< Simple constructor
 ...
 private:
  ...
  MPMTfakeTrigger_args* args; ///< thread args (also holds pointer to the thread)
